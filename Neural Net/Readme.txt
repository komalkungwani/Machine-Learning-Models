The neural_net.py file contains the code that uses neural network along with tensorflow that works on mnist dataset to predict the number it looks at (0,1,2,3,4,5,6,7,8, or 9).
